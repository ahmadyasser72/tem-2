...
| 11-tagihan   | `docs/wireframe-v2/input/11-tagihan.html`   | `site/src/pages/dashboard/for/invoices/index.astro`      | EXISTS |
...
| 9-laporan-tagihan               | `docs/wireframe-v2/output/9-laporan-tagihan.html`               | `site/src/pages/dashboard/for/invoices/report/html.astro`      | EXISTS                 |
| 10-laporan-tagihan-per-penghuni | `docs/wireframe-v2/output/10-laporan-tagihan-per-penghuni.html` | `site/src/pages/dashboard/for/tenants/report/[id]/html.astro`  | EXISTS (dynamic route) |

## Summary

- **11/11 input wireframes** → corresponding `index.astro` pages exist
- **10/10 output wireframes** → corresponding report/invoice pages exist
